                      ...
                      <div class="row">
                        <div class="col-md-6 mb-4 pb-2">
                          <div class="form-floating">
                            <input type="text" id="form3Examplev2" class="form-control form-control-lg" placeholder="FirstName" />
                        ...
                        <div class="col-md-6 mb-4 pb-2">
                          ...
                          <div class="form-floating">
                            <input type="text" id="form3Examplev3" class="form-control form-control-lg" placeholder="LastName" />
                    ...
                    <div class="p-5">
                      ...
                      <div class="mb-4 pb-2">
                        <div class="form-floating form-white">
                          <input type="text" id="form3Examplea2" class="form-control form-control-lg" placeholder="Street + Nr" />
                      ...
                      <div class="mb-4 pb-2">
                        <div class="form-floating form-white">
                          <input type="text" id="form3Examplea3" class="form-control form-control-lg" placeholder="Additional Information" />
                      ...
                      <div class="row">
                        <div class="col-md-5 mb-4 pb-2">
                          ...
                          <div class="form-floating form-white">
                            <input type="text" id="form3Examplea4" class="form-control form-control-lg" placeholder="Zip Code" />
                        ...
                        <div class="col-md-7 mb-4 pb-2">
                          ...
                          <div class="form-floating form-white">
                            <input type="text" id="form3Examplea5" class="form-control form-control-lg" placeholder="Place" />
                      ...
                      <div class="mb-4 pb-2">
                        <div class="form-floating form-white">
                          <input type="text" id="form3Examplea6" class="form-control form-control-lg" placeholder="Country" />
                      ...
                      <div class="row">
                        <div class="col-md-5 mb-4 pb-2">
                          ...
                          <div class="form-floating form-white">
                            <input type="text" id="form3Examplea7" class="form-control form-control-lg" placeholder="Code +" />
                        ...
                        <div class="col-md-7 mb-4 pb-2">
                          ...
                          <div class="form-floating form-white">
                            <input type="text" id="form3Examplea8" class="form-control form-control-lg" placeholder="Phone Number" />
                      ...
                      <div class="mb-4">
                        <div class="form-floating form-white">
                          <input type="text" id="form3Examplea9" class="form-control form-control-lg" placeholder="Your Email" />
